...
addRandomArticle.addEventListener("click", () => {
    if (getOption() == "Random Author") {
        ...
        let articleTemplate = `'<h1 class="title">${postTitleFromUserId}</h1><ul class="post"><li class="datas">Destination Europe</li><li class="datas">Added by <span class="author">${
            users[userId].name}</span></li><li class="datas">July 01, 2018</li></ul>
  ...
  <img src="https://picsum.photos/${1280}/${720}?dummy=${Math.floor(Math.random() * 100000)}" class="hero-image" alt="Random image"/><div class="content-text"><p>${mussumIpsum}</p></div>'
  `;
        if (
